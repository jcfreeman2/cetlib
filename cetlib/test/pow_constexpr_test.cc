...
int main()
{
  ...
  static_assert(cet::diff_of_squares(13u, 12u) == 25u, "diff_of_squares fail 2");
  static_assert(cet::diff_of_squares(13L, 12L) == 25L, "diff_of_squares fail 3");
  static_assert(cet::diff_of_squares(13., 12.) == 25., "diff_of_squares fail 4");
