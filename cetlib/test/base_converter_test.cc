...
bool
  hex2dec( std::string const & input
         , std::string const & wanted
         )
{
  std::string result;

  try { result = base_converter::hex_to_dec(input); }
  catch( ... ) { return false; }
...
bool
  dec2hex( std::string const & input
         , std::string const & wanted
         )
{
  std::string result;

  try { result = base_converter::dec_to_hex(input); }
  catch( ... ) { return false; }
...
bool
  bin2dec( std::string const & input
         , std::string const & wanted
         )
{
  std::string result;

  try { result = base_converter::bin_to_dec(input); }
  catch( ... ) { return false; }
...
bool
  dec2bin( std::string const & input
         , std::string const & wanted
         )
{
  std::string result;

  try { result = base_converter::dec_to_bin(input); }
  catch( ... ) { return false; }
