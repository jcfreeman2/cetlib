...
double
cet::sqlite::mean(sqlite3* const db, std::string const& table_name, std::string const& column_name)
{
...
double
cet::sqlite::median(sqlite3* const db, std::string const& table_name, std::string const& column_name)
{
  auto r = query<double>(db,
                         "select avg("s+column_name+")"+
...
double
cet::sqlite::rms(sqlite3* const db, std::string const& table_name, std::string const& column_name)
{
  auto r = query<double>(db,
                         "select sum("s+
