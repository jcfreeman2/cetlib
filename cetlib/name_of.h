...
namespace cet {
  ...
  // primary template:
  template< class T > struct name_of;

  // specializations for native types:
  template<> struct name_of<signed char              >;
  template<> struct name_of<int                      >;
  template<> struct name_of<long                     >;
  template<> struct name_of<short                    >;
  template<> struct name_of<long long                >;
  template<> struct name_of<unsigned char            >;
  template<> struct name_of<unsigned int             >;
  template<> struct name_of<unsigned long            >;
  template<> struct name_of<unsigned short           >;
  template<> struct name_of<unsigned long long       >;
  template<> struct name_of<float                    >;
  template<> struct name_of<double                   >;
  template<> struct name_of<long double              >;
  template<> struct name_of<void                     >;
  template<> struct name_of<bool                     >;
  template<> struct name_of<char                     >;

  // specializations for composite types:
  template< class T > struct name_of<T const         >;
  template< class T > struct name_of<T volatile      >;
...
{ static  std::string  is()  { return "schar"; } };

template<>
  struct cet::name_of<int>
{ static  std::string  is()  { return "int"; } };

template<>
  struct cet::name_of<long>
{ static  std::string  is()  { return "long"; } };

template<>
  struct cet::name_of<short>
{ static  std::string  is()  { return "short"; } };
...
{ static  std::string  is()  { return "uchar"; } };

template<>
  struct cet::name_of<unsigned int>
{ static  std::string  is()  { return "uint"; } };

template<>
  struct cet::name_of<unsigned long>
{ static  std::string  is()  { return "ulong"; } };

template<>
  struct cet::name_of<unsigned short>
{ static  std::string  is()  { return "ushort"; } };
...
{ static  std::string  is()  { return "float"; } };

template<>
  struct cet::name_of<double>
{ static  std::string  is()  { return "double"; } };

template<>
  struct cet::name_of<long double>
{ static  std::string  is()  { return "ldouble"; } };
...
{ static  std::string  is()  { return "void"; } };

template<>
  struct cet::name_of<bool>
{ static  std::string  is()  { return "bool"; } };
...
{ static  std::string  is()  { return "ptr-to_" + name_of<T>::is(); } };
