...
///    MU2E_SEARCH_PATH:       may be set by the end-user
///    MU2E_RELEASE_BASE:      should be set by a site administrator
///    MU2E_DATA_PATH:         should be set by a site administrator
///
///  MU2E_SEARCH_PATH is a 'search path' limited to 1 to 3
...
///
///       "MU2E_RELEASE_BASE", which means search the "official place",
///             defined by the value of the MU2E_RELEASE_BASE environment
///             variable, for files.
///
///       "MU2E_DATA_PATH", which means search the "official place",
///             defined by the value of the MU2E_DATA_PATH environment
///             variable, for files.
///
///       ".:MU2E_RELEASE_BASE" or "LOCAL:MU2E_RELEASE_BASE",
///              which means look first in the current working
///              directory, then in the "official place", for files.
///
///       ".:MU2E_DATA_PATH" or "LOCAL:MU2E_DATA_PATH",
///              which means look first in the current working
///              directory, then in the "official place", for files.
///
///       ".:MU2E_RELEASE_BASE:MU2E_DATA_PATH" or "LOCAL:MU2E_RELEASE_BASE:MU2E_DATA_PATH",
///              which means look first in the current working
