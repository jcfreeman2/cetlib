...
namespace cet {
  // trim in place:
  inline std::string &
    trim_right( std::string & source, std::string const & t = " " );
  inline std::string &
    trim_left( std::string & source, std::string const & t = " " );
  inline std::string &
    trim( std::string & source, std::string const & t = " " );

  // trim and return a copy:
  inline std::string
    trim_right_copy( std::string source, std::string const & t = " " );
  inline std::string
    trim_left_copy( std::string source, std::string const & t = " " );
  inline std::string
    trim_copy( std::string source, std::string const & t = " " );
}
