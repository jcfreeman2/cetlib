...
cet::LibraryManager::LibraryManager(cet::search_path search_path,
                                    std::string lib_type) :
  LibraryManager{std::move(search_path), std::move(lib_type), default_pattern_stem}
{}
...
void
cet::LibraryManager::spec_trans_map_inserter(lib_loc_map_t::value_type const& entry)
{
...
void
cet::LibraryManager::good_spec_trans_map_inserter(spec_trans_map_t::value_type const& entry)
{
