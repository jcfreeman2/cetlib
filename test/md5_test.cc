  ...
  main( )
{
...

  {
    ...
    art::MD5Result r = art::Digest(TESTA).digest();
    digest_t  r1;
    std::copy(r.bytes+0, r.bytes+16, &r1[0]);
...

  {
    ...
    art::MD5Result r = art::Digest(TESTB).digest();
    digest_t  r2;
    std::copy(r.bytes+0, r.bytes+16, &r2[0]);
...

  {
    ...
    art::MD5Result r = art::Digest(TESTC).digest();
    digest_t  r3;
    std::copy(r.bytes+0, r.bytes+16, &r3[0]);
